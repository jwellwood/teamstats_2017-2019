...
const styles = theme => ({
  ...
  incomplete: { backgroundColor: theme.palette.primary.dark },
  complete: { backgroundColor: '#28B463' },
          ...
          <Grid container direction="row" justify="space-between" alignItems="center">
            ...
            <Grid item xs={3} className={classes.progress}>
              <Grid container direction="column" justify="flex-end" alignItems="center">
                ...
                <Avatar
                  className={item.total < item.target ? classes.incomplete : classes.complete}
                >
                  {item.total}
                </Avatar>
